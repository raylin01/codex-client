...
export function normalizeCodexThreadMessages(thread) {
    const messages = [];
    const turns = Array.isArray(thread.turns) ? thread.turns : [];
...
export async function listCodexSessionSummaries(client, params = {}) {
...
export async function readCodexSessionRecord(client, threadId, params = {}) {
