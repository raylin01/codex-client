...
exports.StructuredCodexClient = exports.CodexTurnHandle = exports.CodexQuestionSession = void 0;
...
exports.CodexQuestionSession = CodexQuestionSession;
...
class CodexTurnHandle extends events_1.EventEmitter {
    snapshot;
    updateQueue = [];
    updateWaiters = [];
    done;
...
exports.CodexTurnHandle = CodexTurnHandle;
...
class StructuredCodexClient extends events_1.EventEmitter {
    rawClient;
    turns = [];
    pendingTurns = [];
    ...
    static async init(options) {
        const rawClient = new client_js_1.CodexClient(options);
...
exports.StructuredCodexClient = StructuredCodexClient;
